...
function getCopy(lang: Lang) {
  return lang === "zh"
    ? {
        eyebrow: "SKIN CENTER",
        title: "皮肤中心",
        description: "在 DevConduit 中管理主题包，并直接应用到官方 Codex Desktop。",
        refresh: "刷新",
    ...
    : {
        eyebrow: "SKIN CENTER",
        title: "Skin Center",
        description: "Manage theme packs in DevConduit and apply them directly to the official Codex Desktop app.",
        refresh: "Refresh",
