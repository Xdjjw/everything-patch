...
use crate::constants::{
    ...
    JSDELIVR_EXAMPLES_BASE, KILO_BUILTIN_FILENAME, KILO_BUILTIN_ID, PI_BUILTIN_FILENAME,
    PI_BUILTIN_ID, ZCODE_BUILTIN_FILENAME, ZCODE_BUILTIN_ID,
};
...
const OTHER_TOOL_PROMPT_FILENAMES: [&str; 5] = [
    CLAUDE_BUILTIN_FILENAME,
    GROK_BUILTIN_FILENAME,
    KILO_BUILTIN_FILENAME,
    PI_BUILTIN_FILENAME,
    ZCODE_BUILTIN_FILENAME,
];
const OTHER_TOOL_PROMPT_IDS: [&str; 5] = [
    CLAUDE_BUILTIN_ID,
    GROK_BUILTIN_ID,
    KILO_BUILTIN_ID,
    PI_BUILTIN_ID,
