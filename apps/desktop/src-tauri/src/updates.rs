...
const RELEASES_URL: &str = "https://github.com/Xdjjw/everything-patch/releases";
const SHIELDS_KEY: &str = "Shields CDN";
const GITHUB_KEY: &str = "GitHub Releases";
const RELEASE_SOURCES: [RemoteSource<'static>; 2] = [
    RemoteSource::new(
        SHIELDS_KEY,
        "https://img.shields.io/github/v/release/Xdjjw/everything-patch.json?display_name=tag",
        Some("application/json"),
    ),
    RemoteSource::new(
        GITHUB_KEY,
        "https://api.github.com/repos/Xdjjw/everything-patch/releases/latest",
...
mod tests {
    ...
    fn cdn_success_does_not_call_github() {
        ...
        assert_eq!(
            info.html_url,
            "https://github.com/Xdjjw/everything-patch/releases/tag/v0.2.36"
        );
